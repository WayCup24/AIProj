  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profileSection}>
        ...
        <Link replace href="/settings" style={styles.option}>
          <Text style={styles.optionText}>Редактировать профиль</Text>
        </Link>
        <View style={styles.option}>
        ...
        <TouchableOpacity style={styles.option} onPress={handleQuit}>
          <Text style={styles.optionText}>Выйти из профиля</Text>
        </TouchableOpacity>
      </View>
